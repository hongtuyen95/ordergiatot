...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/attribute/listprice')?>">Danh sách khoảng giá</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('vnadmin/attribute/addprice')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnadmin/attribute/deletes_price_category')?>">
                ...
                <table id="example" class="table table-bordered table-striped">
					...
					<thead>
                        ...
                        <tr>
							...
							<th width="">khoảng giá</th>

							<th width="20%" class="no-sort">giá từ</th>

							<th width="20%" class="no-sort">đến giá	</th>
					 ...
					 <?php if (isset($list)) {
						...
						<tr>
							...
							<td><input type="number" onchange="update_sort($(this))" value="<?= @$v->sort ?>"
								...
								data-placement='product_price' data-item='<?= @$v->id; ?>' style="width: 55px"></td>

							<td><?= @$v->name ?></td>

							<td><?= number_format(@$v->from_price) ?></td>

							<td>

                                <?= number_format(@$v->to_price) ?>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-default"
								   ...
								   href="<?= base_url('vnadmin/attribute/editprice/' . $v->id) ?>"><i

										class="fa fa-pencil"></i> </a>

								<a class="btn btn-xs btn-danger"

								   href="<?= base_url('vnadmin/attribute/deletepricecategory/' . $v->id) ?>" title="Xóa"
...
<style>
    ...
    .view_price{width: 10px; height: 10px;margin-top: 5px;cursor: pointer; float: left;margin-right: 5px }
