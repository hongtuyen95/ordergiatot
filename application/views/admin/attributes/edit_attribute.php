                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-lg-5">
                                                    <select name="type" id="type_data" class="form-control">
                                                        ...
                                                        <option <?php if($edit->type == 'text'){echo "selected";} ?> value="text">Text</option>
                                                        <option <?php if($edit->type == 'number'){echo "selected";} ?> value="number">Number</option>
                                                        <option <?php if($edit->type == 'selectbox'){echo "selected";} ?> value="selectbox">Select Box</option>
                                                        <option <?php if($edit->type == 'checkbox'){echo "selected";} ?> value="checkbox">Check Box</option>
                                                    </select>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div id="menu2" class="tab-pane fade">
                                            <div class="table-responsive col-sm-7">
                                                <table class="table table-hover" id="discount">
                                                    ...
                                                    <tbody>
                                                        <?php if(count($att_values)) : ?>
                                                            <?php foreach($att_values as $att_value) : ?>
                                                                <tr id="discount-row<?=$att_value->id;?>">
                                                                    <td><input type="text" name="stt[]" class="form-control" value="<?=@$att_value->order;?>"/> </td>
                                                                    <td><input type="value" name="value[]" class="form-control" value="<?=@$att_value->values;?>"/> </td>
                                                                    <td><a class="btn btn-danger btn-xs" onclick="deleteAttribute(<?=$att_value->id?>)">Xóa</a></td>
                                                                </tr>
                                                            <?php endforeach;?>
                                                        <?php endif;?>
                                                    </tbody>
...
<!--
    ...
    function addDiscount() {
        ...
        html += '<tr>';
        html += '<td width="20%"><input type="text" class="form-control" name="stt[]" value="" /></td>';
        html += '    <td><input type="text" class="form-control" name="value[]" value="" /></td>';
        html += '    <td class="left"><a onclick="$(\'#discount-row' + discount_row + '\').remove();" class="btn btn-danger btn-xs">Xóa</a></td>';
        html += '  </tr>';
        html += '</tbody>';
    ...
    function deleteAttribute(id){
        $.ajax({
            type: "POST",
            dataType: "json",
            url: '<?php echo base_url('admin/attribute/deleteAttributeAjax')?>',
            data: {id:id},
