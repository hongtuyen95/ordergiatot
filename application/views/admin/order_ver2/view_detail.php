                                    ...
                                    <?php foreach($carts as $cat) : $stt +=1; ?>
                                        ...
                                        <tr>
                                            ...
                                            <td style="font-weight: bold;color:#e85959" class="text-center" width="12%">
                                                ...
                                                <p>
                                                    <a class="btn btn-xs btn-warning"><i class="fa fa-exclamation-triangle"></i> Khiếu nại shop</a>
                                                </p>
                                            </td>
                                            <?php if($sp == 1) : ?>
                                                ...
                                                <td width="25%" rowspan="<?=@$colspan;?>">
                                                    ...
                                                    <p class="form-group"><strong>Cân nặng : 0 Kg</strong></p>
                                                    <p><strong>Thêm cân nặng : </strong><span style="font-weight: bold;color: #f12c2c"><input class="form-control input-sm input-c" id="weight_<?=@$traking->id;?>" /><button class="btn btn-c btn-success btn-sm"><i class="fa fa-floppy-o"></i></button></span></p>
                                                    <p><strong>Phí cân năng : </strong><span style="color:#ec85cd;font-weight: bold">0 VNĐ</span></p>
                                                    <p><strong>Phí ngoài (<i class="fa fa-jpy"></i>): </strong> <span><input class="form-control input-sm input-x" /> <button class="btn btn-c btn-success btn-sm"><i class="fa fa-floppy-o"></i></button></span></p>
                                                    <p><strong>Phí ngoài (vnđ): </strong><span><input class="form-control input-sm input-x" /> <button class="btn btn-c btn-success btn-sm"><i class="fa fa-floppy-o"></i></button></span></p>
                                                    <p><strong>Mã shop : Chưa nhập mã shop <i class="fa fa-pencil-square-o"></i></strong></p>
                                                    <p><strong>Mã đơn vận : Chưa nhập mã đơn vận <i class="fa fa-pencil-square-o"></i> </strong></p>
