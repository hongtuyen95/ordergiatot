        ...
        <div class="container">
            <div class="row_pc">
                <ul class="menu_control_lv">
                    ...
                    <li><a href="<?=base_url('thong-tin-ca-nhan')?>">Thông tin cá nhân</a></li>
                    <li><a href="<?=base_url('hang-that-lac')?>">Hàng thất lạc</a></li>
                    <li><a href="<?=base_url('don-hang')?>">Đơn hàng</a></li>
                    <li  class="active"><a href="<?=base_url('tai-chinh')?>">Tài chính</a></li>
            ...
            <div class="col-md-2 col-xs-12">
                <div class="content_left">
                    <ul>
                        ...
                        <li><a href="<?=base_url('lich-su-giao-dich')?>">Lịch sử giao dịch</a></li>
                    </ul>
                </div>
            </div>
