...
class MY_Loader extends CI_Loader
{
    public function widget($widget_directory, $agrs = array())
    {
	 ...
	 public function views($views, $agrs = array())
    {
        $CI = get_instance();
        // Tạo đường dẫn để load file view trong views
        $this->_ci_view_paths = array(APPPATH . 'views/' . $views . '/' => TRUE);
        // Trả lại phương thức load views cho hệ thống CI
        $this->_ci_view_paths = array(APPPATH . 'views/' => TRUE);
        return $CI->load->view($views,$agrs);
    }
