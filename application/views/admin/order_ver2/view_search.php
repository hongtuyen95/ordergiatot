...
<div class="col_right_body">
    <div class="top_list">
        ...
        <div class="name_page">Tìm kiếms</div>
    </div>
    <div class="clearfix-15"></div>


    <div class="content_page_timkiem">
        <div class="title_file_info">Quản lý khách hàng</div>
        <div class="col_adtimkiem clearfix">
            <form action="" class="form-mail ">
                <div class="input-group">
                    <input type="text" class="form-control input-timdon" id="">

                    <div class="input-group-addon btn btn-search-timdon">
            ...
            <div class="row_pc">
                <div class="col-lg-7 col-md-7 col-sm-6 col-xs-12">
                    <div class="col_ad_tk_left">
                        <h2>Đơn hàng</h2>
                    </div>
                </div>
                <div class="col-lg-5 col-md-5 col-sm-6 col-xs-12">
                    <div class="col_ad_tk_right">
                        <h2>Đơn ship hàng</h2>
                    </div>
                </div>
            </div>
