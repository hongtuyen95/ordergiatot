...
class Crawler{
	...
	public function getImageByClass($class){
		$img = $this->dom->find($class,0)->children(0)->outertext;
		return $img;
	}

	public function getPrice(){
		if(!$price = $this->dom->find('head meta[property="og:product:price"]', 0)){
			return false;
		}

		return $this->clean_text($price->content);
	}
}
