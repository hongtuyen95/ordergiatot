                    ...
                    <div class="col-md-12">
                        <form id="loginform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <input id="login-username" type="text" class="validate[required] form-control"
                                       name="username" value="" placeholder="Email">
                            </div>

                            <div style="margin-bottom: 25px" class="input-group">
                                <span class="input-group-addon"><i class="fa fa-lock"></i></span>
                                <input id="login-password" type="password" class="validate[required] form-control"
                                       name="pass" placeholder="<?=lang('pass');?>">
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-md-12 control">
                            <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" >
                                ...
                                <a onclick="registerModal()" style="cursor: pointer" data-toggle="modal" data-target=".bs-example-modal-sm2">
                                    Đăngng ký
                                </a>
                                <div style="" >
                                    <a href="javascript:void(0)" onclick="getModalForgotPass()">
                                        Quên mật khẩu
                                    </a>
                                </div>
                            </div>
