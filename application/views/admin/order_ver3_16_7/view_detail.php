                    ...
                    <div>
                        ...
                        <div class="col-sm-6">
                            ...
                            <select id="status" name="status" class="form-control input-sm">
                                ...
                                <option <?php if($order->status == 3) : ?>selected<?php endif;?> value="3">Đã mua hàng</option>
                            </select>
                            ...
                            <?php foreach($stores as $shop) : ?>
                                ...
                                <?php $carts = $shop->items; if(count($carts)) : $colspan = count($carts);  ?>
                                    <?php $dem=0; foreach($carts as $cat) : $stt +=1;$dem +=1; ?>
                                        <?php
                                            $sp +=$cat->quantity;$tm += $cat->qty_buy;$th += $cat->price * $cat->quantity;$phi_dich_vu += ($cat->price * $cat->qty_buy * $fee);
                                            $tong_sp += $cat->qty_buy;$tong_tien_hang +=$th;$tong_tien_cong += $phi_dich_vu;
                                        ?>
                                        <tr>
                    ...
                    <div class="col-sm-offset-6 col-sm-6">
                        <table class="table table-bordered">
                            ...
                            <tr>
                                ...
                                <td class="text-right"><span style="color:#00a65a;font-weight: bold"><?=number_format(($tong_tien_hang + $tong_tien_cong + $tong_phi_noi_dia - $tong_tien_thuc_mua) * $order->rate);?> NDT</span></td>
                            </tr>
                        </table>
                    </div>
                </div>
