                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <?php if($info->o_status == 4) : ?>
                                        <button class="btn btn-xs btn-success">
                                            <i class="fa fa-check"></i> Shop Trung Quốc Phát hàng
                                        </button>
                                    <?php endif;?>
                                    <?php if($info->o_status == 5) : ?>
                                        <button class="btn btn-xs btn-success">
                                            <i class="fa fa-check"></i> Kho TQ nhận hàng
                                        </button>
                                    <?php endif;?>
                                    <?php if($info->o_status == 6) : ?>
                                        <button class="btn btn-xs btn-success">
                                            <i class="fa fa-check"></i> Kho VN nhận hàng.
                                        </button>
                                    <?php endif;?>
                                    <?php if($info->o_status == 7) : ?>
                                        <button class="btn btn-xs btn-success">
                                            <i class="fa fa-check"></i> Giao hàng tại Vn
                                        </button>
                                    <?php endif;?>
