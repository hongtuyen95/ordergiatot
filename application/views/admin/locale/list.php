...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/attribute/listLocale')?>">Danh sách xuất xứ</a></li>
...
<section class="content">
    ...
    <div class="box">
        ...
        <div class="box-header">
            ...
            <a href="<?= base_url('vnadmin/attribute/addlocale')?>" class="btn btn-success btn-sm">
        ...
        <div class="box-body">
			...
			<form name="formbk" method="post" action="<?=base_url('vnadmin/attribute/deletes_locale_category')?>">
					 ...
					 <?php if (isset($list)) {
						...
						<tr>
							...
							<td><input type="number" onchange="update_sort($(this))" value="<?= @$v->sort ?>"
								...
								data-placement='locale'	   data-item='<?= @$v->id; ?>' style="width: 55px"></td>
							...
							<td class="text-center">
								...
								<a class="btn btn-xs btn-default"
								   ...
								   href="<?= base_url('vnadmin/attribute/editlocale/' . $v->id) ?>"><i

										class="fa fa-pencil"></i> </a>

								<a class="btn btn-xs btn-danger"

								   href="<?= base_url('vnadmin/attribute/deletelocalecategory/' . $v->id) ?>" title="Xóa"
