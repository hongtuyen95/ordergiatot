    ...
    <div class="content_page_donhang">
        <div class="tab_info_admin">
            <ul class="nav nav-tabs">
                ...
                <li><a href="<?=base_url('vnadmin/order/orders?status=1')?>">Chưa duyệt <span>(<?=$status1;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=2')?>">Đã duyệt <span>(<?=$status2;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=3')?>">Đã thanh toán <span>(<?=$status3;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=4')?>">Đã mua hàng <span>(<?=$status4;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=5')?>">Đã tất toán <span>(<?=$status5;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=6')?>">Hàng đã về <span>(<?=$status6;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=7')?>">Đã giao hàng <span>(<?=$status7;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=8')?>">Kết thúc đơn <span>(<?=$status8;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=9')?>">Đã hủy <span>(<?=$status9;?>)</span></a></li>
                <li><a href="<?=base_url('vnadmin/order/orders?status=10')?>">Hết hàng<span>(<?=$status10;?>)</span></a></li>
            </ul>
                        ...
                        <?php if(count($lists)) : $stt = 0; ?>
                            <?php foreach($lists as $list) : $stt +=1; ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <?php if($list->status == 1) : ?><span class="btn btn-xs btn-default">Chưa duyệt<span><?php endif;?>
                                        <?php if($list->status == 2) : ?><span class="btn btn-xs btn-success">Đã duyệt<span><?php endif;?>
                                        <?php if($list->status == 3) : ?><span class="btn btn-xs btn-success">Đã thanh toán<span><?php endif;?>
                                        <?php if($list->status == 4) : ?><span class="btn btn-xs btn-success">Đã mua<span><?php endif;?>
                                        <?php if($list->status == 5) : ?><span class="btn btn-xs btn-success">Đã tất toán<span><?php endif;?>
                                        <?php if($list->status == 6) : ?><span class="btn btn-xs btn-success">Hàng đã về<span><?php endif;?>
                                        <?php if($list->status == 7) : ?><span class="btn btn-xs btn-success">Đã giao hàng<span><?php endif;?>
                                        <?php if($list->status == 8) : ?><span class="btn btn-xs btn-success">Kết thúc đơn<span><?php endif;?>
                                        <?php if($list->status == 9) : ?><span class="btn btn-xs btn-danger">Đã hủy<span><?php endif;?>
                                        <?php if($list->status == 10) : ?><span class="btn btn-xs btn-danger">Hết hàng<span><?php endif;?>
                                    </td>
                                </tr>
                            <?php endforeach;?>
                        <?php endif;?>
