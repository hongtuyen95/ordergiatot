...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/raovat/categories')?>">Danh mục tin rao</a></li>
						...
						<div class="form-group">
							...
							<div class="col-sm-12">
								...
								<select name="parent" class="form-control">
									...
									<?php show_cate($cate,0,'',@$edit->parent_id,@$edit->id);?>
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-12" id="view_img">
								...
								if(file_exists(@$edit->image)){ ?>
									...
									<button  type="button" onclick="delete_image($(this))" data-placement="raovat_category" class="btn btn-success btn-xs"><i class="fa fa-times"></i> Xóa ảnh</button>
