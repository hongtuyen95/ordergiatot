...
<div class="col-sm-12">
    ...
    <div class="col-md-10 col-xs-12">
        <div class="clearfix">
                ...
                <div class="panel-body">
                    <div class="row">
                        ...
                        <div class="col-sm-2 text-center">
                            <button onclick="booking()" type="button" class="btn btn-success hidden btn-lg">Đặt hàng</button>
            ...
            <div class="table-responsive">
                        <table class="table table-bordered table-cart">
                            ...
                            <?php foreach($shops as $shop) : ?>
                                <tbody>
                                <tr class="info">
                                    <td><input type="checkbox" name="check_all_shop"></td>
                                    <td colspan="4">
                                        <strong>Người bán : <span style="color:#27ab5c ;"><?=$shop;?></span></strong>
                                    </td>
                                    <td colspan="2">
                                        <input type="checkbox" name="phi_kiem_hang[]"> <strong> <span >Phí kiểm hàng</span></strong>
                                    </td>
                                </tr>
                                        ...
                                        <?php if(@$cart['seller_name'] == $shop) : ?>
                                            <tr>
                                                <td class="text-center">
                                                    <input name="rowid[]" onclick="DoCheckOne('formorder')" id="rowid" class="cartid" data-key="<?=@$cart['key'];?>" value="<?=@$cart['rowid'];?>" type="checkbox">
                                                </td>
                                                <td>
                                                    <div class="cart-img">
                                                ...
                                                <td class="text-center">
                                                    <p style="color: #ff0055">
                                                        <?=number_format(@$cart['item_price'] * @$cart['qty'] * $cart['fee'] * $this->option->exchange);?> VNĐ
                                                    </p>
                                                    <p>
                                                        <?php $pmh = @$cart['item_price']*@$cart['qty']* $cart['fee']; ?>
                                                        ¥ <?=number_format($pmh,2);?>
                                                    </p>
                                                </td>
                                                <td class="text-center">
                                                    <a href="<?=base_url('cart/deleteItemCart?id='.@$cart['key']);?>" class="btn btn-xs btn-warning"><i class="fa fa-trash"></i> Xóa</a>
                                                </td>
                                            </tr>
                                        <?php endif;?>
                                    <?php endforeach;?>
            ...
            <div class="panel panel-default tongtien_fix">
                <div class="panel-body">
                    <div class="row">
                        <div class="col-sm-2" style="min-width: 100px;">
                            <input name="checkAll" id="checkall" onclick="DoCheck(this.checked,'formorder',0)" class="cartid" value="" type="checkbox"> <strong>Chọn tất cả</strong>
                            <br>
                            <a href="javascript:void(0)" onclick="delete_item()" class="btn btn-warning btn-xs">Xóa sản phẩm</a>
                        </div>
                        <div class="col-sm-8 text-center" style="font-size: 14px;min-width: 270px;">
                            <div class="row">
                                <p><strong>Tổng số shop: <span class="total_shop"><?=count($shops);?></span> - </strong>  <strong>Tổng số link: <span class="total_links">0</span></strong></p>
                                <p><strong>Tổng số sản phẩm: <span class="total_items">0</span> - </strong><strong>Tổng tiền: ¥ <span class="total_prices_2">0</span>  -  <span class="total_prices">0</span> đ</strong></p>
                            </div>

                        </div>
                        <div class="col-sm-2 text-center" style="min-width: 100px;">
                            <button type="button" onclick="booking()" class="btn btn-success hidden btn-lg">Đặt hàng</button>
...
<script type="text/javascript">
    ...
    $("input[name='check_all_shop']").click(function() {
        if ($(this).is(":checked")) {
            $(this).parent().parent().parent().find('.cartid').prop('checked', true);
        }else{
            $(this).parent().parent().parent().find('.cartid').prop('checked', false);
        }
