...
<section class="content-header">
    ...
    <ol class="breadcrumb">
        ...
        <li class="active"><a href="<?= base_url('vnadmin/options/listAll')?>">Danh mục kích thước</a></li>
                    ...
                    <div class="panel-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12" id="error-alias">
                                <input type="text" id="size" class="form-control input-sm" name="size"
                                    value="<?= @$edit->size; ?>" placeholder=""/>
                            </div>
