...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
			<div class="col-sm-6" >
				  <a href="<?= base_url('vnadmin/tag/addtagpro')?>" class="btn btn-success btn-sm">
        ...
        <!-- /.box-header -->
        <div class="box-body">
			<form name="formbk" method="post" action="<?=base_url('vnadmin/tag/deletestagpro')?>">
                <table id="example" class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							...
							<td><?= $stt++; ?></td>
							<td class="todo-list"><a href="<?= base_url('vnadmin/tag/edittagpro/' . $v->id) ?>" title="Sửa thẻ tag">
                                <?= @$v->name ?>
                                </a>
							</td>
							<td><?= @$v->alias ?></td>
							<td class="text-center">
								<a class="btn btn-xs btn-default"
								   href="<?= base_url('vnadmin/tag/edittagpro/' . $v->id) ?>"><i
										class="fa fa-pencil"></i> </a>
								<a class="btn btn-xs btn-danger"
								   href="<?= base_url('vnadmin/tag/deletetagpro/' . $v->id) ?>" title="Xóa"
